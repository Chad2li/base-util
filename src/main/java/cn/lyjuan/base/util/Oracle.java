...
public class Oracle
{
	...
	{
		if (this.idColumn == null || this.idColumn.trim().length() == 0) { throw new RuntimeException(
				"必须设置insertSequence！"); }
		this.setBeanToInsertOrUpdateFields(t);
	...
	{
		if (this.pool != null && this.pool.length() > 0) { return PoolDBUtils.getConnection(this.pool); }
